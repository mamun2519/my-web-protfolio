    ...
    <div className="bg-[#19282F]">
      <footer className="text-[#fff] body-font max-w-7xl m-auto lg:px-2 px-6">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <div className="w-20 pr-3 rounded-full">
            <img className=" rounded-full" src="/Asstes/picture/logo3.jpg" alt="" />
            </div>
            <span className="ml-3 text-xl text-[#fff]">
              Juboraj Islam Mamun
            </span>
          </a>
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a
              ...
              target="_blank"
              className="text-[#fff] p-2 rounded-full border"
            >
              <svg
                fill="currentColor"
                strokeLinecap="round"
            ...
            <a
              ...
              target="_blank"
              className="ml-3 text-[#fff] p-2 rounded-full border"
            >
              <svg
                fill="none"
                stroke="currentColor"
